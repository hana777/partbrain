...
#plateinfo <-cbind(plateinfo[,c(1,3,4)], substr(plateinfo[,6], 6, 12))	
#plateinfo <-data.frame(plateinfo)
#names(plateinfo)<-c('id', 'order', 'structure_id', 'style')
	
plateinfo <-cbind(plateinfo[,c(2,3,5)], substr(plateinfo[,6], nchar(plateinfo[1,6])-6, nchar(plateinfo[1,6]) ) )
plateinfo <-data.frame(plateinfo)
names(plateinfo)<-c('id', 'order', 'structure_id', 'style')
